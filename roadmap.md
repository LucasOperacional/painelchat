...
- [x] Publicar a aplicação (deploy)
- [x] Webhook da Evolution/WuzAPI apontando para o endereço publicado
- [x] Agendamentos (sentinela/monitor) no endereço publicado
- [x] Verificação de conexões/filas/realtime em produção
- [x] Menu de controle enviado ao administrador 5562910002123
