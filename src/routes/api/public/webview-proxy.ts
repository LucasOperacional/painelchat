...
function rewriteHtml(html: string, id: string, target: URL) {
 ...
 function janelaInterna(n){var href="about:blank",loc={assign:function(u){href=String(u||"");abreDentro(href);},replace:function(u){href=String(u||"");abreDentro(href);},reload:function(){},toString:function(){return href;}};try{Object.defineProperty(loc,"href",{get:function(){return href;},set:function(v){href=String(v||"");abreDentro(href);}});}catch(e){}var doc={open:function(){return doc;},close:function(){},write:function(x){try{var m=String(x||"").match(/https?:[^'\"<>\\s]+/i);if(m&&interno(m[0]))baixa(m[0]);}catch(e){}}};var win={name:n||"_blank",closed:false,document:doc,focus:function(){return true;},blur:function(){},close:function(){win.closed=true;},postMessage:function(){}};try{Object.defineProperty(win,"location",{get:function(){return loc;},set:function(v){href=String(v||"");abreDentro(href);}});}catch(e){win.location=loc;}return win;}
